...
class Order(models.Model):
    ...
    order_status = models.CharField(
        max_length=10, choices=STATUS_OPTIONS, default=STATUS_OPTIONS[0][0]
    )
    auth_required = models.CharField(max_length=50, choices=AUTH_OPTIONS)
    dm_auth = models.CharField(
        max_length=10, choices=AUTH_RESPONSE, default=AUTH_RESPONSE[0][0]
    )
